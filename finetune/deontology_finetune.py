...
def train(args):
    base_dir = './ethics'
    train_name = 'deontology/deontology_train.csv'
    test_name = 'deontology/deontology_test.csv'
    test_hard_name = 'deontology/deontology_test_hard.csv'

    tokenizer = load_tokenizer(args)

    # load dataset
    train_dataset = EthicsDataset(tokenizer, os.path.join(base_dir, train_name), 'deontology')
    test_dataset = EthicsDataset(tokenizer, os.path.join(base_dir, test_name), 'deontology')
    test_hard_dataset = EthicsDataset(tokenizer, os.path.join(base_dir, test_hard_name), 'deontology')
