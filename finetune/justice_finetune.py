...
def train(args):
    ...
    # load dataset
    train_dataset = EthicsDataset(tokenizer, os.path.join(base_dir, train_name), 'justice')
    test_dataset = EthicsDataset(tokenizer, os.path.join(base_dir, test_name), 'justice')
    test_hard_dataset = EthicsDataset(tokenizer, os.path.join(base_dir, test_hard_name), 'justice')
